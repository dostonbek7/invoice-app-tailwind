        ...
        <>
          ...
          <div className="w-[327px] h-[695px] bg-[#fff] rounded-lg shadow-[0_10px_10px_-10px_rgba(72, 84, 159, 0.10)] p-6">
            ...
            <div className="flex items-center overflow-hidden gap-2 w-[375px] h-[91px] bg-[#fff] shadow-[0_10px_10px_-10px_rgba(72, 84, 159, 0.10)]">
              <button className="btn btn-ghost text-true-lavender font-bold text-base">Edit</button>
              <button className="btn btn-error text-[#fff] font-bold text-base">Delete</button>
              <button className="btn btn-primary text-[#fff] font-bold text-base">Mark as Paid</button>
            </div>
          </div>
        </>
      )}
